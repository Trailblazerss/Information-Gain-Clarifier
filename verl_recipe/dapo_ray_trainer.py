...
#
# This file is derived from the verl project (https://github.com/volcengine/verl)
# Original file: recipe/dapo/dapo_ray_trainer.py
"""
...
class RayDAPOTrainer(RayPPOTrainer):
    """
    DAPO Trainer that runs on the driver process on a single CPU/GPU node.
    """
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    # Compute rollout correction weights and off-policy metrics
